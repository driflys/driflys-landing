...
function TermsConditions() {
  return (
    <Page title={`Terms & Conditions - Driflys`}>
      <main className="bg-white">
        <section className="container pt-8">
          <h1 className="text-4xl">Terms and Conditions ("Terms")</h1>
          <p className="mt-2">
            Our Terms and Conditions were last updated on <strong>August 01, 2022</strong>.
          </p>
        ...
        <section className="container mt-8">
          ...
          <ul>
            ...
            <li>{`●	“Subscription” refers a paid plan offered by the company with recurring billing. `}</li>
        ...
        <section className="container mt-8">
          <h1 className="text-4xl">User Accounts</h1>
          <p className="mt-4">
        ...
        <section className="container mt-8">
          ...
          <h2 className="mt-4 text-2xl">Your Right to Post Content</h2>
          <p className="mt-4">
          ...
          <h2 className="mt-4 text-2xl">Content Restrictions</h2>
          <p className="mt-4">
          ...
          <p className="mt-4">
            ...
            indecent, incorrect or objectionable, and You agree that under no circumstances will the Company be liable
            in any way for any content, including any errors or omissions in any content, or any loss or damage of any
            kind incurred as a result of your use of any content.
          </p>

          <h2 className="mt-4 text-2xl">Content Backups</h2>
          <p className="mt-4">
        ...
        <section className="container mt-8">
          ...
          <h2 className="mt-4 text-2xl">Intellectual Property Infringement</h2>
          <p className="mt-4">
          ...
          <p className="mt-4">
            ...
            must submit Your notice in writing to the attention of our copyright agent via email (contact@driflys.com)
          ...
          <h2 className="mt-4 text-2xl">DMCA Notice and DMCA Procedure for Copyright Infringement Claims</h2>
          <p className="mt-4">
          ...
          <p className="mt-4">
            You can contact our copyright agent via email (contact@driflys.com). Upon receipt of a notification, the
        ...
        <section className="container mt-8">
          <h1 className="text-4xl">Purchasing Subscriptions</h1>
          <p className="mt-4">
            By purchasing a Subscription though the Service, You warrant that You are legally capable of entering into
            binding contracts.
          </p>
          <h2 className="text-2xl mt-4">Your Information</h2>
          <p className="mt-4">
            If You wish to purchase a Subscription available on the Service, You may be asked to supply certain
            information relevant to Your Subscription including, without limitation, Your name, Your email, Your phone
          ...
          <h2 className="text-2xl mt-4">Prices Policy</h2>
          <p className="mt-4">
            The Company reserves the right to revise its prices at any time prior to accepting an Subscription.
          </p>

          <p className="mt-4">
            The prices quoted may be revised by the Company subsequent to accepting an Subscription in the event of any
            occurrence affecting delivery caused by government action, higher foreign exchange costs and any other
            matter beyond the control of the Company. In that event, You will have the right to cancel Your Order.
          </p>

          <h2 className="text-2xl mt-4">Payments</h2>
          <p className="mt-4">
            Payment can be made through various payment methods we have available, such as Visa, MasterCard, Affinity
          ...
          <h2 className="text-2xl mt-4">Promotions</h2>
          <p className="mt-4">
          ...
          <p className="mt-4">
            If You participate in any Promotions, please review the applicable rules as well as our Privacy policy. If
            the rules for a Promotion conflict with these Terms, the Promotion rules will apply.
          </p>
        </section>

        <section className="container mt-8">
          <h1 className="text-4xl">Intellectual Property</h1>
          <p className="mt-4">
        ...
        <section className="container mt-8">
          <h1 className="text-4xl">Your Feedback to Us</h1>
          <p className="mt-4">
        ...
        <section className="container mt-8">
          ...
          <h2 className="mt-4 text-2xl">Severability</h2>
          <p className="mt-4">
          ...
          <h2 className="mt-4 text-2xl">Waiver</h2>
          <p className="mt-4">
        ...
        <section className="container mt-8">
          <h1 className="text-4xl">Changes to These Terms and Conditions</h1>
          <p className="mt-4">
...
TermsConditions.layout = MainLayout
