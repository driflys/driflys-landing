        ...
        <section className="container mt-16">
          <div className="flex flex-col gap-6 items-center md:flex-row md:justify-between md:items-center">
            <div className="flex-1">
              ...
              <p className="mt-4 text-gray-500">{`You can give your receivers a fully branded experience with their certificates.
As the issuer, you have full control over the design and appearance of the certificates.`}</p>
        ...
        <section className="bg-zinc-900">
          <div className="container py-16">
            ...
            <h1 className="mt-6 mx-auto text-4xl font-semibold text-center text-white max-w-3xl md:text-6xl">{`Tailored fit customizations with
Premium branding`}</h1>
            <p className="mt-6 mx-auto text-center text-gray-200 max-w-3xl">{`Give your certificate receivers a truly native experience `}</p>
